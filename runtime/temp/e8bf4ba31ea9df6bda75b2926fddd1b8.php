<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"/Users/luodiao/Sites/admin/public/../application/admin/view/general/profile/index.html";i:1555662058;s:69:"/Users/luodiao/Sites/admin/application/admin/view/layout/default.html";i:1555662058;s:66:"/Users/luodiao/Sites/admin/application/admin/view/common/meta.html";i:1555662058;s:68:"/Users/luodiao/Sites/admin/application/admin/view/common/script.html";i:1555662058;}*/ ?>
<!DOCTYPE html>
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.profile/update'); ?>">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="email" name="row[email]" value="<?php echo $admin['email']; ?>" data-rule="required;email"/>
                        </div>
                        <div class="form-group">
