<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/Users/luodiao/Sites/admin/public/../application/admin/view/new_keyword/edit.html";i:1559202575;s:69:"/Users/luodiao/Sites/admin/application/admin/view/layout/default.html";i:1555662058;s:66:"/Users/luodiao/Sites/admin/application/admin/view/common/meta.html";i:1555662058;s:68:"/Users/luodiao/Sites/admin/application/admin/view/common/script.html";i:1555662058;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-key" class="form-control" name="row[key]" type="text" value="<?php echo $row['key']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-desc" class="form-control " rows="5" name="row[desc]" cols="50"><?php echo $row['desc']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Wxid'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-wxid" class="form-control" name="row[wxid]" type="text" value="<?php echo $row['wxid']; ?>">
        </div>
    </div>
    <div class="form-group">
